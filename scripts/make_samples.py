...
# 3) BOM — Old(-1Q) / New(0Q). 가상 Assy 2개, 일부는 신규/삭제/변경.
bom_old_rows = [
    ["ASSY-FRAME-01", "SMP-1001", "WASHER-SPACER 8mm", 2],
    ["ASSY-FRAME-01", "SMP-1002", "BOLT M8x20", 4],
    ["ASSY-FRAME-01", "SMP-1003", "BRACKET SWING", 1],
    ["ASSY-PIPING-01", "SMP-1004", "PIPE ASSY FUEL", 1],
    ["ASSY-PIPING-01", "SMP-1005", "COVER UNDER", 1],
]
save(bom_old_rows, ["Assy", "품번", "품명", "개수"], "bom_old.xlsx")

bom_new_rows = [
    ["ASSY-FRAME-01", "SMP-1001", "WASHER-SPACER 8mm", 3],   # 개수 변경 2→3
    ["ASSY-FRAME-01", "SMP-1002", "BOLT M8x20", 4],           # 동일
    # SMP-1003 삭제
    ["ASSY-PIPING-01", "SMP-1004", "PIPE ASSY FUEL", 2],      # 개수 변경 1→2
    ["ASSY-PIPING-01", "SMP-1005", "COVER UNDER", 1],         # 동일
    ["ASSY-PIPING-01", "SMP-1001", "WASHER-SPACER 8mm", 1],   # 신규 편입
]
save(bom_new_rows, ["Assy", "품번", "품명", "개수"], "bom_new.xlsx")
